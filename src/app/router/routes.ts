...
export const ROUTES: RouteMeta[] = [
  ...
  {
    path: '/legacy-profile/refund-apply',
    title: '申请退款',
    titleBar: 'hidden',
    nodes: [],
    task: 'T028',
    entry: '小票详情-申请退款',
    returnTo: '小票详情',
    owner: '申请退款页（T028 APP 内原生闭环；小票信息卡 + 全额/指定金额切换 + 5 个退款原因 + 退款到账方式说明 + 提交后扣减 store.balance + 跳成功页）',
  },
  {
    path: '/legacy-profile/refund-success',
    title: '退款成功',
    titleBar: 'hidden',
    nodes: [],
    task: 'T028',
    entry: '申请退款-提交',
    returnTo: '个人中心',
    owner: '退款成功页（T028；渐变金勾 + 本次退款金额 + 退款后账户余额 + 返回个人中心/查看退款记录）',
  },
  {
