...
2026-09-07 新增 T039：机器端消费密码领取/核销。卡博士自助机器上学生输入手机尾号 + 6 位消费密码即可领取/核销。需新建独立页面承载该交互，区分于既有 Settings / Onboarding / PasswordVerify。
...
| [T039](./T039-machine-pin-consume.md) | 机器端消费密码领取/核销 | Draft |
