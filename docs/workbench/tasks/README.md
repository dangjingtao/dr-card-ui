...
2026-09-07 新增 T039：机器端消费密码领取/核销。卡博士自助机器上学生输入手机尾号 + 6 位消费密码即可领取/核销。入口位置 2026-09-07 决定：「我的」页宫格新增"消费密码"，紧跟常用设备/收藏设备之后。
...
| [T039](./T039-machine-pin-consume.md) | 机器端消费密码领取/核销（「我的」宫格入口） | Doing |
